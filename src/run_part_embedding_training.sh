...
#  python ./convert_global_variables.py;
#  cd shape_embedding_training;
#  /usr/local/MATLAB/R2016a/bin/glnxa64/MATLAB -nodisplay -r compute_shape_distance_matrix;
#  cd ..;
#fi
#
## Step 05
...
#  python ./convert_global_variables.py;
#  cd shape_embedding_training;
#  /usr/local/MATLAB/R2016a/bin/glnxa64/MATLAB -nodisplay -r compute_shape_embedding_space;
#  cd ..;
#fi
