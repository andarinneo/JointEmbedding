...
def extract_cnn_features(img_filelist, img_root, prototxt, caffemodel, feat_name, output_path=None, output_type=None, caffe_path=None, mean_file=None, gpu_index=0, pool_size=8):   
    ...
    if mean_file:
        ...
        imagenet_mean = caffe.io.resize_image(imagenet_mean.transpose((1, 2, 0)), (3, 227, 227))
    ...
    def compute_feat_array(batch_idx):    
        ...
        net.predict(input_data, oversample=False)  # predict takes any number of images, and formats them for the Caffe net automatically
