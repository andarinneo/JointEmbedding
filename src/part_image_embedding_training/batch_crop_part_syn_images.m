...
image_list = collect_image_list_segmentation(g_syn_images_folder, g_shape_list_file);
...
% batch_crop_segmentation(g_syn_images_folder, g_syn_images_cropped_folder, 1, image_list, cropRatios);
% delete(poolobj);
% 
% exit;
