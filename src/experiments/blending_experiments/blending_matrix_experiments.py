...
BASE_DIR = '/home/adrian/JointEmbedding/src/shape_interpolation/'
...
n_imgs = 6
for img1_id in range(8, 8+1):
    for img2_id in range(1, n_imgs+1):
        path = '/home/adrian/Desktop/matrixPartMatchExperiment/'
        ...
        parser.add_argument('--image1', help='Path to input image (cropped)', required=False, default= path + 'part2_' + 'img' + str(img1_id) + '.jpg')
        ...
        parser.add_argument('--image2', help='Path to input image (cropped)', required=False, default= path + 'part3_' + 'img' + str(img2_id) + '.jpg')
        ...
        case_id = str(img1_id) + str(img2_id)
        visualization_filename = path + 'image_based_' + codes_4_parts[args.part_id1] + '+' + codes_4_parts[args.part_id2] + '_blending_case' + case_id + '.html'
