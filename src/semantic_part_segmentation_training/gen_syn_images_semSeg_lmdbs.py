...
env = lmdb.open(g_pool5_semSeg_lmdb, readonly=True)
if os.path.exists(g_pool5_semSeg_lmdb_train):
    shutil.rmtree(g_pool5_semSeg_lmdb_train)
env_train = lmdb.open(g_pool5_semSeg_lmdb_train, map_size=int(1e12))
if os.path.exists(g_pool5_semSeg_lmdb_val):
    shutil.rmtree(g_pool5_semSeg_lmdb_val)
env_val = lmdb.open(g_pool5_semSeg_lmdb_val, map_size=int(1e12))
